# 0. Abstract
In the [Shopee Code League - Product Detection challenge (Student category)](https://www.kaggle.com/c/shopee-product-detection-student/overview), our team (Servants of the Joy) managed to obtain a private leaderboard score of [0.82648](https://www.kaggle.com/c/shopee-product-detection-student/leaderboard) (highest: 0.86804) and cliched the 33rd place in the student catgory (top 5%). 
